...
public class SSPawner1 : MonoBehaviour
{
    ...
    public static GameObject objIdent1;
    public GameObject objIname1;
    ...
    public void Update()
    {
        ...
        if (spawnCTRL == true) //If this is true then we want to spawn 
        {
            ...
            if (t >= 1f) //Spawn after one second.
            {
               ...
               objIdent1 = Instantiate(spheres[rand_s], this.transform.position+(new Vector3(0, 15, 0)), transform.rotation); // This will spawn sphere at position + units
                objIdent1.gameObject.name = "S1";
                objIname1 = Instantiate(SphereIdentifiers[rand_i], this.transform.position, transform.rotation); //This will spawn the sphere Identifiers.
                objIname1.gameObject.name = "S1I";
                spawnCTRL = false;
            }
        t = t % 1;
