...
public class SSPawner5 : MonoBehaviour
{
    ...
    public static GameObject objIdent5;
    public GameObject objIname5;
    ...
    public void Update()
    {
        ...
        if (spawnCTRL == true) //If this is true then we want to spawn 
        {
            ...
            if (t >= 1f) //Spawn after one second.
            {
                ...
                objIdent5 = Instantiate(spheres[rand_s], this.transform.position+(new Vector3(0, 15, 0)), transform.rotation); // This will spawn sphere at position + units
