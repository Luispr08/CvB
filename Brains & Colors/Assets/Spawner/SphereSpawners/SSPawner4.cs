...
public class SSPawner4 : MonoBehaviour
{
    ...
    public static GameObject objIdent4;
    public GameObject objIname4;
    ...
    public void Update()
    {
        ...
        if (spawnCTRL == true) //If this is true then we want to spawn 
        {
            ...
            if (t >= 1f) //Spawn after one second.
            {
                ...
                objIdent4 = Instantiate(spheres[rand_s], this.transform.position+(new Vector3(0, 15, 0)), transform.rotation); // This will spawn sphere at position + units
                objIdent4.gameObject.name = "S4";
                objIname4 = Instantiate(SphereIdentifiers[rand_i], this.transform.position, transform.rotation); //This will spawn the sphere Identifiers.
                objIname4.gameObject.name = "S4I";
                spawnCTRL = false;
            }
        t = t % 1;
