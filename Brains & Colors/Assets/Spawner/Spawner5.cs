...
public class Spawner5 : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            int RanNum = rangen.n5; //Generates a random number between 1 and 7 to choose for the number
                                     ...
                                     * this way I can control whether the 3rd wave of cubes should spawn.
                                    ...
                                    */
            if (time >= 2f) //Hihger this number for less frequency; lower for more frequency // FirstSpawn means the player started the game. RespawnFlag means the player has been playing
            {
