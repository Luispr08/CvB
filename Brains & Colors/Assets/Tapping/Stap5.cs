...
public class Stap5 : MonoBehaviour
{
    ...
    public void OnMouseDown()
    {
        ...
        if (this.gameObject.name == "S2")//Means it spawned at spawnpoint 1
        {
            //We clicked the right color at spawn 1.
            //We clicked the right color at spawn 1.
        ...
        if (this.gameObject.name == "S3")//Means it spawned at spawnpoint 1
        {
            //We clicked the right color at spawn 1.
            //We clicked the right color at spawn 1.
        ...
        if (this.gameObject.name == "S4")//Means it spawned at spawnpoint 1
        {
            //We clicked the right color at spawn 1.
            //We clicked the right color at spawn 1.
        ...
        if (this.gameObject.name == "S5")//Means it spawned at spawnpoint 1
        {
            //We clicked the right color at spawn 1.
            //We clicked the right color at spawn 1.
